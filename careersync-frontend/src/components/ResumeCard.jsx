    ...
    <div className="bg-white border border-slate-200 shadow-sm rounded-3xl overflow-hidden w-full max-w-lg relative group transition-all flex flex-col font-sans">
      ...
      <div className="p-8 flex-1">
        <div className="flex justify-between items-start mb-8 border-b border-slate-100 pb-6">
          <div>
            ...
            <div className="flex items-center gap-2">
              <p className="text-blue-600 text-xs font-bold uppercase tracking-widest">Candidate Profile</p>
        ...
        <div className="space-y-8">
          <section className="relative pl-6 border-l-2 border-blue-200">
            <Quote size={24} className="absolute -left-3 -top-2 text-blue-400 bg-white p-0.5" />
      ...
      <div className="p-5 bg-slate-50 border-t border-slate-100">
        <button
          ...
          className="w-full py-3.5 bg-blue-600 text-white rounded-xl flex items-center justify-center gap-2 font-bold text-sm shadow-sm hover:bg-blue-700 transition-colors"
        >
