      ...
      <div className="w-full max-w-4xl">
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-12 md:p-16 text-center">
          ...
          <div className="flex justify-center">
            <Link to="/dashboard" className="px-8 py-4 bg-blue-600 text-white rounded-xl text-lg font-bold shadow-sm hover:bg-blue-700 transform hover:-translate-y-0.5 transition-all">
